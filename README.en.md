...
# Pyxel.Animation.Image

Animate the image (sprite).
...
```bash
git clone https://github.com/ytyaru/Python.Pyxel.Animation.Image.20200331135254
cd Python.Pyxel.Animation.Image.20200331135254/src
./run.sh
```
